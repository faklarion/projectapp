...
class Tbl_project_model extends CI_Model
{
	...
	$this->db->or_like('status_approval', $q);
	$this->db->or_like('status_bonus', $q);
...
/* End of file Tbl_project_model.php */
/* Location: ./application/models/Tbl_project_model.php */
