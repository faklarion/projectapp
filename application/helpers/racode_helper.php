...
function tgl_indo($tanggal){
    if (is_null($tanggal) || empty($tanggal)) {
        return 'Belum Ada Tanggal'; // Atau bisa juga mengembalikan 'Tanggal tidak valid' atau nilai lain sesuai kebutuhan
    }
    ...
    // Pastikan panjang array pecahkan adalah 3 sebelum mengakses
    if (count($pecahkan) !== 3) {
        return ''; // Mengembalikan nilai kosong jika format tanggal tidak valid
    }
